...
describe MarkdownToPDF::Image do
  ...
  it 'creates image in a html table' do
    ...
    expect_pdf([
                 ...
                 { x: 36.0, y: 744.756, text: "Lorem ipsum dolor sit amet, consetetur" },
                 { x: 36.0, y: 730.884, text: "sadipscing elitr, sed diam nonumy " },
                 { x: 257.324, y: 744.756, text: "Lorem ipsum dolor sit" },
                 { x: 257.324, y: 730.884, text: "amet, consetetur" },
                 { x: 257.324, y: 717.012, text: "sadipscing elitr, sed diam" },
                 { x: 257.324, y: 703.14, text: "nonumy " },
